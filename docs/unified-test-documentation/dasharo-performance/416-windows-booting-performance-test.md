...
## BWI001.001 Boot Windows stable from disk after cold-boot

**Test description**

This test aims to verify that Windows stable could be booted from the disk
...
## BWI002.001 Boot Windows stable from disk after warm-boot
...
## BWI003.001 Boot Windows stable from disk after reboot
