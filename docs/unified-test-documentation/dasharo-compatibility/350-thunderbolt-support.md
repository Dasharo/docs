# Dasharo Compatibility: Thunderbolt support
...
## TBS001.001 Thunderbolt charging capability (Ubuntu 22.04)

**Test description**

This test verifies that the Thunderbolt port is able to provide charging to a
...
1. Connect a phone to the Thunderbolt port on the DUT using a USB cable.
...
## TBS002.001 Thunderbolt PD laptop charging (Ubuntu 22.04)

**Test description**

This test verifies that the laptop can be charged using a USB Type-C PD power
supply connected to the Thunderbolt port.
...
1. Boot into the system.
1. Log into the system by using the proper login and password.
1. Connect the charger plug to the Thunderbolt port on the DUT.
1. Observe the battery indicator located in the top right corner of the screen.

**Expected result**

The battery indicator should indicate that the laptop is currently charging.

## TBS002.002 Thunderbolt laptop charging (Windows 11)
...
## TBS003.001 Thunderbolt Display output (Ubuntu 22.04)

**Test description**

This test verifies that DUT output video to a display connected via the
Thunderbolt port.
...
1. Boot into the system.
1. Log into the system by using the proper login and password.
1. Connect a display to the Thunderbolt port using a USB Type-C hub.
...
The monitor connected to the laptop via the Thunderbolt port should power on and
display video from the laptop.

## TBS003.002 Thunderbolt Display output (Windows 11)
...
## TBS004.001 Thunderbolt docking station laptop charging (Ubuntu 22.04)
...
## TBS004.002 Thunderbolt docking station laptop charging (Windows 11)
...
## TBS005.001 Thunderbolt docking station HDMI display (Ubuntu 22.04)
...
## TBS005.002 Thunderbolt docking station HDMI display (Windows 11)
...
## TBS006.001 Thunderbolt docking station DP display (Ubuntu 22.04)
...
## TBS006.002 Thunderbolt docking station DP display (Windows 11)
...
## TBS007.001 Thunderbolt docking station triple display (Ubuntu 22.04)
...
## TBS007.002 Thunderbolt docking station triple display (Windows 11)
...
## TBS008.001 Thunderbolt docking station detection after coldboot (Ubuntu 22.04)
...
## TBS009.001 Thunderbolt docking station detection after warmboot (Ubuntu 22.04)
...
## TBS010.001 Thunderbolt docking station detection after reboot (Ubuntu 22.04)
...
## TBS011.001 Thunderbolt docking station USB devices recognition (firmware)
...
## TBS011.002 Thunderbolt docking station USB devices recognition (Ubuntu 22.04)
...
## TBS011.003 Thunderbolt docking station USB devices recognition (Windows 11)
...
## TBS012.001 Thunderbolt docking station USB keyboard recognition (firmware)
...
## TBS012.002 Thunderbolt docking station USB keyboard detection (Ubuntu 22.04)
...
## TBS012.003 Thunderbolt docking station USB keyboard recognition (Windows 11)
...
## TBS013.001 Thunderbolt docking station upload 1GB file on USB storage (Ubuntu 22.04)
...
## TBS013.002 Thunderbolt docking station upload 1GB file on USB storage (Windows 11)
...
## TBS014.001 Thunderbolt docking station ethernet connection (Ubuntu 22.04)
...
## TBS014.002 Thunderbolt docking station ethernet connection (Windows 11)
...
## TBS015.001 Thunderbolt docking station audio recognition (Ubuntu 22.04)
...
## TBS015.002 Thunderbolt docking station audio recognition (Windows 11)
...
## TBS016.001 Thunderbolt docking station audio playback (Ubuntu 22.04)
...
## TBS016.002 Thunderbolt docking station audio playback (Windows 11)
...
## TBS017.001 Thunderbolt docking station audio capture (Ubuntu 22.04)
...
## TBS017.002 Thunderbolt docking station audio capture (Windows 11)
