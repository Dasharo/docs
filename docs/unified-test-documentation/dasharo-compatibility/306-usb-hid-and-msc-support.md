...
## USB000.001 Enable USB stack (Firmware)
...
1. Connect USB `OS installer` to the DUT.
1. Reboot the device.
1. While booting, press the `SETUP_MENU_KEY` to enter Setup Menu.
...
1. USB installer should be visible as bootable device.
1. USB device should be visible/operable in the OS.

## USB000.002 Disable USB stack (Firmware)
...
1. USB installer should not be visible as bootable device.
1. USB device should not be visible/operable in the OS.

## USB000.003 Enable USB Mass Storage (Firmware)
...
## USB000.004 Disable USB Mass Storage (Firmware)
