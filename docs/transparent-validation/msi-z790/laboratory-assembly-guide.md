...
1. Check if the headers are soldered to the board. If not - 4 pin header
    ...
    ![sonoff_without_header](../msi-z690/images/sonoff_without_header.jpg)

    ![sonoff_with_header](../msi-z690/images/sonoff_with_header.jpg)

1. Connect the USB-UART converter to the USB port.

    ![uart connection](../msi-z690/images/sonoff-s20-uart.jpg)
