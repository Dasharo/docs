...
Openness Score for msi_ms7d25_v1.1.7_ddr5.rom

Open-source code percentage: **38.4%**
Closed-source code percentage: **61.6%**

* Image size: 33554432 (0x2000000)
* Number of regions: 36
* Number of CBFSes: 4
* Total open-source code size: 5666814 (0x5677fe)
* Total closed-source code size: 9085267 (0x8aa153)
* Total data size: 1224111 (0x12adaf)
* Total empty size: 17578240 (0x10c3900)

![](msi_ms7d25_v1.1.7_ddr5.rom_openness_chart.png)

![](msi_ms7d25_v1.1.7_ddr5.rom_openness_chart_full_image.png)
...
| SMMSTORE | 0x1000000 | 0x80000 | data |
...
* CBFS size: 4816640
* Number of files: 15
* Open-source files size: 1856170 (0x1c52aa)
* Closed-source files size: 1544305 (0x179071)
* Data size: 13147 (0x335b)
* Empty size: 1403018 (0x15688a)
...
| CBFS filename | CBFS filetype | Size | Compression | Category |
| ------------- | ------------- | ---- | ----------- | -------- |
| fallback/payload | simple elf | 1403612 | none | open-source |
| fallback/romstage | stage | 113192 | none | open-source |
| fallback/ramstage | stage | 170823 | LZMA | open-source |
| fallback/dsdt.aml | raw | 11578 | none | open-source |
| fallback/postcar | stage | 90036 | none | open-source |
| stm.bin | raw | 66929 | LZMA | open-source |
| cpu_microcode_blob.bin | microcode | 474112 | none | closed-source |
| fspm.bin | fsp | 786432 | none | closed-source |
| fsps.bin | fsp | 283761 | LZ4 | closed-source |
| config | raw | 6038 | LZMA | data |
| revision | raw | 903 | none | data |
| build_info | raw | 138 | none | data |
| vbt.bin | raw | 1257 | LZMA | data |
| sbom | raw | 3674 | none | data |
...
* CBFS size: 4161536
* Number of files: 19
* Open-source files size: 1954474 (0x1dd2aa)
* Closed-source files size: 1544305 (0x179071)
* Data size: 13533 (0x34dd)
* Empty size: 649224 (0x9e808)
...
| (empty) | null | 648868 | none | empty |

## v1.1.6

Openness Score for msi_ms7d25_v1.1.6_ddr5.rom
...
* Number of CBFSes: 4
* Total open-source code size: 5740367 (0x57974f)
* Total closed-source code size: 9261395 (0x8d5153)
* Total data size: 949242 (0xe7bfa)
* Total empty size: 17603428 (0x10c9b64)

![](msi_ms7d25_v1.1.6_ddr5.rom_openness_chart.png)

![](msi_ms7d25_v1.1.6_ddr5.rom_openness_chart_full_image.png)
...
* CBFS size: 4816640
* Number of files: 13
* Open-source files size: 1882053 (0x1cb7c5)
* Closed-source files size: 1515633 (0x172071)
* Data size: 8878 (0x22ae)
* Empty size: 1410076 (0x15841c)
...
| CBFS filename | CBFS filetype | Size | Compression | Category |
| ------------- | ------------- | ---- | ----------- | -------- |
| fallback/payload | simple elf | 1538182 | none | open-source |
| fallback/romstage | stage | 106504 | none | open-source |
| fallback/ramstage | stage | 157417 | LZMA | open-source |
| fallback/dsdt.aml | raw | 11398 | none | open-source |
| fallback/postcar | stage | 68552 | none | open-source |
| cpu_microcode_blob.bin | microcode | 445440 | none | closed-source |
| fspm.bin | fsp | 786432 | none | closed-source |
| fsps.bin | fsp | 283761 | LZ4 | closed-source |
...
* CBFS size: 4161536
* Number of files: 17
* Open-source files size: 1976261 (0x1e27c5)
* Closed-source files size: 1515633 (0x172071)
* Data size: 9346 (0x2482)
* Empty size: 660296 (0xa1348)
