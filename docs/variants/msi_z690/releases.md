...
- [Memory overclocking support with XMP
  profiles](https://docs.dasharo.com/dasharo-menu-docs/dasharo-system-features/#memory-configuration)
- [Compatibility with Raptor Lake Refresh
  CPUs](https://github.com/Dasharo/dasharo-issues/issues/534)
...
- [Some RPL-S CPUs (0xB06F2 (RPL-S C0) or 0xB06F5 (RPL-S H0)) have problem
  with booting on v1.1.2](https://github.com/Dasharo/dasharo-issues/issues/496)
...
- Power LED on blinking during S3 sleep
...
- [Windows 11 installer unable to detect i225 Ethernet
  NIC](https://github.com/Dasharo/dasharo-issues/issues/482)
- [Cannot wake from suspend via RTC on
  QubesOS](https://github.com/Dasharo/dasharo-issues/issues/484)
