...
* Number of CBFSes: 2
* Total open-source code size: 2314428 (0x2350bc)
* Total closed-source code size: 4983646 (0x4c0b5e)
* Total data size: 409566 (0x63fde)
* Total empty size: 680968 (0xa6408)
...
* CBFS size: 3002368
* Number of files: 17
* Open-source files size: 2314428 (0x2350bc)
* Closed-source files size: 523102 (0x7fb5e)
* Data size: 8130 (0x1fc2)
* Empty size: 156708 (0x26424)
...
| CBFS filename | CBFS filetype | Size | Compression | Category |
| ------------- | ------------- | ---- | ----------- | -------- |
| fallback/romstage | stage | 47198 | LZ4 | open-source |
| fallback/ramstage | stage | 125617 | LZMA | open-source |
...
| fallback/payload | simple elf | 2081955 | none | open-source |
