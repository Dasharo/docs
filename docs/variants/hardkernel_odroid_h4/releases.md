...
- Initial support for the Alder Lake N - based Hardkernel Odroid H4 device
...
- [coreboot based on 24.02 revision fa704d3c](https://github.com/Dasharo/coreboot/tree/fa704d3c)
  - [License](https://github.com/Dasharo/coreboot/blob/fa704d3c/COPYING)
...
- [Intel microcode version ADL-N N0 0x17 0x17 07/12/2023](https://github.com/intel/Intel-Linux-Processor-Microcode-Data-Files/tree/microcode-20240531/intel-ucode/06-be-00)
