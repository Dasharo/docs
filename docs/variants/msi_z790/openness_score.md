...
Openness Score for msi_ms7e06_v0.9.5_ddr5.rom
...
* Number of CBFSes: 4
* Total open-source code size: 5668869 (0x568005)
* Total closed-source code size: 9085267 (0x8aa153)
* Total data size: 1223920 (0x12acf0)
* Total empty size: 17576376 (0x10c31b8)

![](msi_ms7e06_v0.9.5_ddr5.rom_openness_chart.png)

![](msi_ms7e06_v0.9.5_ddr5.rom_openness_chart_full_image.png)
...
* CBFS size: 4816640
* Number of files: 14
* Open-source files size: 1856855 (0x1c5557)
* Closed-source files size: 1544305 (0x179071)
* Data size: 13074 (0x3312)
* Empty size: 1402406 (0x156626)
...
| CBFS filename | CBFS filetype | Size | Compression | Category |
| ------------- | ------------- | ---- | ----------- | -------- |
| fallback/payload | simple elf | 1404141 | none | open-source |
| fallback/romstage | stage | 113192 | none | open-source |
| fallback/ramstage | stage | 170979 | LZMA | open-source |
...
* CBFS size: 4161536
* Number of files: 19
* Open-source files size: 1955159 (0x1dd557)
* Closed-source files size: 1544305 (0x179071)
* Data size: 13488 (0x34b0)
* Empty size: 648584 (0x9e588)
...
| (empty) | null | 647524 | none | empty |

## v0.9.4

Openness Score for msi_ms7e06_v0.9.4_ddr5.rom
...
* Number of CBFSes: 4
* Total open-source code size: 5740274 (0x5796f2)
* Total closed-source code size: 9261395 (0x8d5153)
* Total data size: 949335 (0xe7c57)
* Total empty size: 17603428 (0x10c9b64)

![](msi_ms7e06_v0.9.4_ddr5.rom_openness_chart.png)

![](msi_ms7e06_v0.9.4_ddr5.rom_openness_chart_full_image.png)
...
* CBFS size: 4816640
* Number of files: 13
* Open-source files size: 1882022 (0x1cb7a6)
* Closed-source files size: 1515633 (0x172071)
* Data size: 8909 (0x22cd)
...
| CBFS filename | CBFS filetype | Size | Compression | Category |
| ------------- | ------------- | ---- | ----------- | -------- |
| fallback/payload | simple elf | 1538152 | none | open-source |
| fallback/romstage | stage | 106504 | none | open-source |
| fallback/ramstage | stage | 157416 | LZMA | open-source |
...
* CBFS size: 4161536
* Number of files: 17
* Open-source files size: 1976230 (0x1e27a6)
* Closed-source files size: 1515633 (0x172071)
* Data size: 9377 (0x24a1)
