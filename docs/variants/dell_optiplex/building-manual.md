...
To patch the Dasharo binary you need several tools. They are included in [DTS](../../../dasharo-tools-suite/overview/)
...
!!! warning
    ...
    info at issue [#1530](https://github.com/Dasharo/dasharo-issues/issues/1530).
