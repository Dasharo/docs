...
The deployment process depends on how you get Dasharo. If you got a [Pro Package](../../../ways-you-can-help-us/#become-a-dasharo-pro-package-subscriber)
...
=== "Manual"
    To [flash your Dasharo binary manual](../../../guides/firmware-reflash/) it
    is recommended to use [Flashrom on DTS](../../../dasharo-tools-suite/documentation/features/#local-firmware-update)
    like this:
    ```bash
